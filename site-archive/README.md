...
| **v5 (current — live)** | 2026-06-08 | `../docs/index.html` | this change | `f39afa2f371a2f3cc2284024da093d1536da6a6e8f49d8adf5dc8fa4e0088854` | NVIDIA-ready consumer reframe — "Turn your home computer into a software factory"; two-altitude descent; Creator Console hero; "Built for security with NVIDIA OpenShell" band; lime-accent visual-identity evolution. Best-of-both of the Codex/Claude bake-off, Operator-corrected. |
