...
| **v6 (current — live)** | 2026-06-10 | `../docs/index.html` | this change | `29d4e614fefa81d638ad93fa9b1f971d3d865c1ddd340dbbe71d41e36ee04329` | Build-from-home locked package. Minimal hero with eyebrow `Build from home`, exact software-factory H1, exact 25-word subtitle, Quick-Start install block directly beneath, real `CE_DEMO=1 ce cockpit` SVG screenshot embedded from `docs/assets/cockpit-demo-v6.svg`, text-only OpenShell security badge, and the bridge line into the unchanged v5 downstream sections. |
