...
| **v6.1 (current — live)** | 2026-06-10 | `../docs/index.html` | this change | `1a3f2645826d5d5bf7bfec2c87502a3c25f493f453cecb53e1cb6602c4802539` | Copy-button micro-addition to v6 (Operator-directed convention fix): the install one-liner gains a `Copy` button (flex row, violet ghost style, lime `Copied` confirm) + the page's first/only inline script (clipboard-only, no network, no tracking). Nothing else touched. |
