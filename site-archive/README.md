...
| **v3 (current — live)** | 2026-06-07 | `../docs/index.html` | this change | `fac5fa4de6de2530b43de4640b67282aa73c21a0dae5005927c3b478b5226201` | FOMO + visual-augmentation pass on the v2 system: era hero + anxiety couplet, "Propose · Ratify · Ship" refrain, governance scoreboard (true-by-construction), governed-flow diagram with the human gate on the critical path, auditable-in-the-open ledger panel, trust-debt curve, and a maturity ladder. Honest-metrics-only; implicit competitor positioning. |
