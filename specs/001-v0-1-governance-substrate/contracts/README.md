...
| review-evidence (Batch 2D.1 lift of [`../../../docs/delivery/REVIEW_EVIDENCE_TEMPLATE.md`](../../../docs/delivery/REVIEW_EVIDENCE_TEMPLATE.md); landed) | `docs/contracts/review-evidence.md`, `schemas/review-evidence.schema.yaml`, `templates/review-evidence.template.yaml` | FR-001, FR-027 (Batch 2D.1 schema-class lift; sibling Batch 2D.2 architect-evidence schema landed; Batch 2D.3 implementer-evidence schema remains downstream) |
| architect-evidence (Batch 2D.2 schema-class authoring; landed) | `docs/contracts/architect-evidence.md`, `schemas/architect-evidence.schema.yaml`, `templates/architect-evidence.template.yaml` | FR-001, FR-027 (Batch 2D.2 schema-class authoring; sibling Batch 2D.1 review-evidence schema landed; Batch 2D.3 implementer-evidence schema remains the next downstream privileged schema-class gate) |
| implementer-evidence (Batch 2D.3 schema-class authoring; locally authored under a Source-ratified privileged `schema`-class implementer envelope; awaiting controller verification and Source ratification before merge) | `docs/contracts/implementer-evidence.md`, `schemas/implementer-evidence.schema.yaml`, `templates/implementer-evidence.template.yaml` | FR-001, FR-027 (Batch 2D.3 schema-class authoring; sibling Batch 2D.1 review-evidence and Batch 2D.2 architect-evidence schemas landed; does not amend their semantics; does not authorize ratification, merge, deploy, branch deletion, branch protection mutation, live repository-settings change, provider/tool/model/host/account binding, tenant binding, or authority expansion) |
