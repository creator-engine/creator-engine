...
- Persist a permanent `completion_sealed` marker in one terminal replacement, block and audit sealed restart entries by fingerprint, retain legacy `completion_pending` fail-closed behavior, and fail closed on post-replace durability uncertainty.
