---
slug: adr-0015-premerge-classes
date: 2026-07-19
kind: added
...
**ADR-0015 — Pre-delegated merge classes (MC0, MC1, MC2): land the ratified decision record for zero-gesture merge tiers.**

- Added `docs/decisions/ADR-0015-pre-delegated-merge-classes.md` — the Operator-ratified (2026-07-19) decision record codifying the three pre-delegated merge policy tiers.
