...
- Fix the **install-answers schema mirror drift** that caused `INSTALL_REFUSED artifact_hash_mismatch` on every fresh install.
- Add a **Dockerfile image-build smoke tier** to PR validation.
