...
Optional container variables:
  ...
  CE_DAEMON_IMAGE                  canonical runtime image; default ghcr.io/creator-engine/creator-engine/ce-runtime:0.3.6
...
main() {
  ...
  local image="${CE_DAEMON_IMAGE:-ghcr.io/creator-engine/creator-engine/ce-runtime:0.3.6}"
