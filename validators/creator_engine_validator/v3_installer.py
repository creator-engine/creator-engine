...
from .bootstrap_manifest import (
    ...
    BootstrapWheel,
    PythonAcquisition,
    parse_bootstrap_manifest as _shared_parse_bootstrap_manifest,
    parse_sha256s,
)
...
def parse_bootstrap_manifest(spec_bytes: bytes | str) -> BootstrapManifest:
    """Parse the shared bootstrap artifact manifest, preserving InstallRefused."""
    return _shared_parse_bootstrap_manifest(spec_bytes, error_cls=InstallRefused)
