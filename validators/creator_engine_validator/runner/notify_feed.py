...
CLASS_CLEAR = "clear"
_EVENT_CLASS = {EVENT_ENTRY: CLASS_RATIFY_NEEDED, EVENT_EXIT: CLASS_CLEAR}
_CLASS_URGENCY = {CLASS_RATIFY_NEEDED: "critical", CLASS_CLEAR: "normal"}
...
def default_config() -> NotifyConfig:
    ...
    return NotifyConfig(
        classes={CLASS_RATIFY_NEEDED: DIAL_IMMEDIATE, CLASS_CLEAR: DIAL_IMMEDIATE},
