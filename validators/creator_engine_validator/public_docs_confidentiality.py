...
* the fast standalone CLI check ``scan-public-docs-confidentiality``, also
  included in the optional local ``ce validate-pr`` diagnostic,
...
confidential ce-ops# ticket reference|playbooks/controller/briefs/annoyance-to-tool.md,playbooks/controller/duties.yaml,playbooks/controller/envelope.template.yml,playbooks/controller/runbooks/controller-standup.md,playbooks/controller/workflow.ce.yml,playbooks/reviewer/README.md,playbooks/reviewer/envelope.template.yml,playbooks/reviewer/harness.md,playbooks/reviewer/workflow.ce.yml,site-archive/README.md,site-archive/index-v7-the-choice.html,specs/006-retire-speckit-principle-x/tasks.md,tools/egress-broker/README.md
...
internal hosting-provider name|.ce/changelog/ce113-openbao-golive.md,.ce/changelog/ce249-redact-live-infra.md,.ce/pr-manifests/ce113-openbao-golive.md,validators/tests/unit/test_public_docs_confidentiality_cli.py
internal seat-login marker|.ce/brain/assertions.yaml,.ce/changelog/ce85-plain-join.md,.ce/changelog/ceops94-finegrained-bootstrap.md,.ce/coordination.yml,.ce/reference/cli.generated.md,.github/CODEOWNERS,deploy/systemd/README.md,deploy/systemd/ce-belt-daemon-observed-run.md,deploy/systemd/ce-egress-broker.socket
