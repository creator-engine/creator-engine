...
confidential ce-ops# ticket reference|playbooks/controller/briefs/annoyance-to-tool.md,playbooks/controller/briefs/dispatch.md,playbooks/controller/envelope.template.yml,playbooks/controller/workflow.ce.yml,playbooks/reviewer/README.md,playbooks/reviewer/envelope.template.yml,playbooks/reviewer/harness.md,playbooks/reviewer/workflow.ce.yml,site-archive/README.md,site-archive/index-v7-the-choice.html,specs/006-retire-speckit-principle-x/tasks.md,tools/egress-broker/README.md
...
internal hosting-provider name|.ce/changelog/ce113-openbao-golive.md,.ce/changelog/ce249-redact-live-infra.md,.ce/pr-manifests/ce113-openbao-golive.md,validators/creator_engine_validator/checks/fleet_manifest_guard.py,validators/tests/unit/test_fleet_manifest_guard.py,validators/tests/unit/test_public_docs_confidentiality_cli.py
