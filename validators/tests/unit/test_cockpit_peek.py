...
def test_peek_headless_target_can_visually_inspect_without_tailing_logs() -> None:
    ...
    assert target["stream_ref"] == "/state/headless/stream.log"
...
def test_l3_peek_request_routes_herdr_and_headless_capabilities() -> None:
    ...
    assert "input seam" in blocked["reason"]
