...
def test_registry_discovery_uses_live_pane_pid_and_harness_matrix(tmp_path: Path):
    proc_root = tmp_path / "proc"
    _host_proc(proc_root)
...
def test_herdr_registry_session_is_live_only_when_pid_is_probeable(tmp_path: Path):
    proc_root = tmp_path / "proc"
    _host_proc(proc_root)
