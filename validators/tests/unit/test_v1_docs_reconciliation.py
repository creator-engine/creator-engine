...
def test_as_built_ce_inventory_matches_expected():
    ...
    assert _ce_command_groups() == {
        ...
        "pickup", "dispatch", "playbook", "check", "scan-runtime-policy", "doctor", "init", "launch", "hud",
        ...
        "review-pickup", "review-spawn-provider", "ratifier-queue", "escalation", "notify", "reap", "seat-scratch", "status", "show",
