...
def test_app_jwt_runner_registers_no_check_and_no_backend():
    ...
    assert len(registered_checks()) == 65  # G-6 added ce_scope; v3.5-C A-C1..A-C4 added decision_record + storage_tier_finding + peer_authority + forge_claim_dedup; v3.5-E.3 E3-G1 added install_answers; ce-ops#26 added seat_event; ce-ops#142 added ce_computer_use_authority_envelope; ce-ops#145 added ce_playbook_format; ce-ops#167 added ce_brain_assertions; ce-ops#163 added seat_class_policy; ce-ops#168 added work_sizing; ce-ops#164/#170 added work_sizing_floor; ce-ops#23 S1 added brownfield_baseline_attestation; ce-ops#177 added ce_brain_drift; ce-ops#185 added devops_privileged_action_broker; ce-ops#162 added operator_runbook_refusal_sync; ce-ops#244 added worker_tier_contract; ce-ops#260 added release_artifact_parity_guard
